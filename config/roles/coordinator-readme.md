...
- **角色名称**: 和谐者
- **英文标识**: coordinator
- **性格特征**: 查看 /Users/lijian/clawd/workspaces/coordinator/SOUL.md
...
clawdbot --profile coordinator agent --channel feishu
```

## 配置详情
- **网关端口**: 18803
- **认证令牌**: f25b9de155ed0fb20f99c376
- **工作空间**: /Users/lijian/clawd/workspaces/coordinator
- **飞书群组**: oc_a0553eda9014c201e6f6dbd88a00f0b4

## 文件结构
```
/Users/lijian/clawd/workspaces/coordinator/
├── SOUL.md              # 角色性格定义
├── IDENTITY.md          # 角色身份信息
├── USER.md             # 用户信息
├── AGENTS.md           # 工作空间说明
