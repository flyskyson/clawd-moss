...
- **角色名称**: 实干家
- **英文标识**: executor
- **性格特征**: 查看 /Users/lijian/clawd/workspaces/executor/SOUL.md
...
clawdbot --profile executor agent --channel feishu
```

## 配置详情
- **网关端口**: 18802
- **认证令牌**: e9dc33a455ed0fb20f99c376
- **工作空间**: /Users/lijian/clawd/workspaces/executor
- **飞书群组**: oc_a0553eda9014c201e6f6dbd88a00f0b4

## 文件结构
```
/Users/lijian/clawd/workspaces/executor/
├── SOUL.md              # 角色性格定义
├── IDENTITY.md          # 角色身份信息
├── USER.md             # 用户信息
├── AGENTS.md           # 工作空间说明
